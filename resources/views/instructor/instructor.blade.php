...
<div class="container has-text-centered" style="background-color:#191919; height: 500px; border-radius: 5px; margin-top: -3em; padding-right: 3em;">
	<div class="has-text-centered" style="padding-top: 3em;">
		<a class="button" style=" border-color:#191919;background-color: #191919; height: 60px;  margin-left: 1em;"href="/instructor">
	...
	<div class="has-text-centered" style="font-family:Bahnschrift; padding-top: 1em;">
	<a class="btn has-text-centered" href="/begin" style="font-size: 15px; ">Class Setup</a>
	</div>
	<div class="has-text-centered" style="margin-left: 13em; margin-top: 3em; height: 200px;  overflow: auto;">
      <table class="table" style="background-color: inherit;">
       <tr>
        ...
        <th style="color: grey; font-weight: bolder; font-family:Bahnschrift;">Email</th>
        <th style="color: grey; font-weight: bolder; font-family:Bahnschrift;">Phone</th>
        <th style="color: grey; font-weight: bolder; font-family:Bahnschrift;">Account Type</th>
       </tr>
       @foreach($records as $student)
       <tr>
        <td style="color: green; font-family:Bahnschrift; ">{{ $student->userId }}</td>
        <td style="color: white; font-family:Bahnschrift; ">{{ $student->userFirstName }}</td>
        <td style="color: white; font-family:Bahnschrift; ">{{ $student->userLastName }}</td>
        <td style="color: white; font-family:Bahnschrift; ">{{ $student->email }}</td>
        <td style="color: white; font-family:Bahnschrift; ">{{ $student->userPhone }}</td>
        <td style="color: #40E0D0; opacity: 0.4; font-family:Bahnschrift; "><input type="hidden" name="userType" value="S">Student</td>
       </tr>
       @endforeach
      </table>
     </div>
