...
<div class="container has-text-centered" style="background-color:#191919; height: 500px; border-radius: 5px; margin-top: -3em; padding-right: 3em;">
	<div class="has-text-centered" style="padding-top: 3em;">
		...
		<a class="button" style="border-color:#191919;background-color: #191919; height: 60px;  margin-left: 1em;"href="rewards">
	...
	<div class="has-text-centered" style="font-family:Bahnschrift; font-size: 25px; opacity: 0.4; padding-top: 1em; text-align: center;">
		Make Rewards
	</div>
